...
static const char * const ts_symbol_names[] = {
  ...
  [sym_sixth] = "sixth",
  [sym_seventh] = "seventh",
  [aux_sym_tsv_repeat1] = "tsv_repeat1",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_tsv_repeat1] = aux_sym_tsv_repeat1,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [3] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tsv, 0),
  [5] = {.entry = {.count = 1, .reusable = false}}, SHIFT(15),
  [7] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tsv, 1),
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tsv_repeat1, 2),
  [11] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_tsv_repeat1, 2), SHIFT_REPEAT(15),
